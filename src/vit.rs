...
impl State {
    ...
    fn if_statement(&mut self, predicate: Expr,
...
mod tests {
    ...
    fn valid_declaration_with_assignment() {
        ...
        _ = state.parse_statement(Statement::Declaration("a".to_string(),
    ...
    fn declaration_with_shadowing() {
        ...
        state.parse_statement(Statement::Declaration("a".to_string(),
        Some(vit_grammar::ExprParser::new().parse("24").unwrap())));
    ...
    fn assign_to_undefined_variable() {
        ...
        let result = state.parse_statement(Statement::Assignment("a".to_string(),
    ...
    fn assign_to_variable() {
        ...
        let result = state.parse_statement(
